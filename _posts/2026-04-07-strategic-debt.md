...
As the marginal cost of adding AI falls, the temptation is to do more. But if strategic debt has a similar effect on decision-making as unfactored code has on products, the smarter move may be to do less. When evaluating AI use cases, consider the debt implications alongside the anticipated value. I've often used [the RICE prioritisation formula](https://www.intercom.com/blog/rice-simple-prioritization-for-product-managers/) with clients to help prioritise ideas&#8212;(Reach × Impact × Confidence) ÷ Effort. Adding Debt as a variable&#8212;so the divisor becomes (Effort + Debt)&#8212;seems like a useful extension that I'm going to try. How one would quantify Debt on a comparable scale to Effort is a question I'm still working through&#8212;but even asking the question changes the conversation. At minimum, it means asking: how reversible is this, what ongoing commitments does it create, and can we still explain our reasoning without it?

...
Outputting just those companies using one of those SIC codes resulted in an extract of 12,150 companies. Once I had this, I worked on a second stage Python script to generate monthly delta files so I can keep my dataset updated with new company formations and changes to status. The outputs from both scripts are small enough that I can work with them in Excel, at least for an experimental phase (down the road, I will automate repeated analysis in Python). 
...
Overall, the distribution of companies is about as I would have expected: a small number of very large businesses, a significant long tail of small and medium sized enterprises, and not much in between. Though it’s even starker than I would have thought.  
